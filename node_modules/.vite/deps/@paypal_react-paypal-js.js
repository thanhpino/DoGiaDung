...
(function(SCRIPT_LOADING_STATE$1) {
	SCRIPT_LOADING_STATE$1["INITIAL"] = "initial";
	SCRIPT_LOADING_STATE$1["PENDING"] = "pending";
	SCRIPT_LOADING_STATE$1["REJECTED"] = "rejected";
	SCRIPT_LOADING_STATE$1["RESOLVED"] = "resolved";
...
*/
var DISPATCH_ACTION;
(function(DISPATCH_ACTION$1) {
	DISPATCH_ACTION$1["LOADING_STATUS"] = "setLoadingStatus";
	DISPATCH_ACTION$1["RESET_OPTIONS"] = "resetOptions";
	DISPATCH_ACTION$1["SET_BRAINTREE_INSTANCE"] = "braintreeInstance";
...
(function(PAYPAL_HOSTED_FIELDS_TYPES$1) {
	PAYPAL_HOSTED_FIELDS_TYPES$1["NUMBER"] = "number";
	PAYPAL_HOSTED_FIELDS_TYPES$1["CVV"] = "cvv";
	PAYPAL_HOSTED_FIELDS_TYPES$1["EXPIRATION_DATE"] = "expirationDate";
	PAYPAL_HOSTED_FIELDS_TYPES$1["EXPIRATION_MONTH"] = "expirationMonth";
	PAYPAL_HOSTED_FIELDS_TYPES$1["EXPIRATION_YEAR"] = "expirationYear";
	PAYPAL_HOSTED_FIELDS_TYPES$1["POSTAL_CODE"] = "postalCode";
...
var PayPalHostedFieldsProvider = function(_a) {
	...
	(0, import_react.useEffect)(function() {
		...
		if (!hostedFields.current) throw new Error(generateMissingHostedFieldsError((_a$1 = { components: options.components }, _a$1[SDK_SETTINGS.DATA_NAMESPACE] = options[SDK_SETTINGS.DATA_NAMESPACE], _a$1)));
...
var PayPalHostedField = function(_a) {
	...
	(0, import_react.useEffect)(function() {
		...
		hostedFieldContext.registerHostedField((_a$1 = {}, _a$1[hostedFieldType] = {
...
var PayPalCardFieldsProvider = function(_a) {
	...
	(0, import_react.useEffect)(function() {
		...
		try {
			cardFieldsInstance.current = (_c$1 = (_b$1 = (_a$1 = getPayPalWindowNamespace$1(options[SDK_SETTINGS.DATA_NAMESPACE])).CardFields) === null || _b$1 === void 0 ? void 0 : _b$1.call(_a$1, __assign({}, proxyProps))) !== null && _c$1 !== void 0 ? _c$1 : null;
		} catch (error) {
			setError(function() {
		...
		if (!cardFieldsInstance.current) {
			setError(function() {
				var _a$2;
				throw new Error(generateMissingCardFieldsError((_a$2 = { components: options.components }, _a$2[SDK_SETTINGS.DATA_NAMESPACE] = options[SDK_SETTINGS.DATA_NAMESPACE], _a$2)));
			});
			return;
		}
