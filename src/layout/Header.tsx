...
export const Header: React.FC = () => {
    ...
    return (
        <nav className="sticky top-0 z-50 bg-white/95 dark:bg-gray-900/95 backdrop-blur-md border-b border-orange-100 dark:border-gray-700 shadow-sm transition-all">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-20 gap-4">
                    ...
                    <Link to="/home" className="flex items-center gap-2 hover:opacity-90 transition group shrink-0">
                        ...
                        <span className="text-xl md:text-2xl font-extrabold text-gray-800 dark:text-white tracking-tight">
                    ...
                    <div className="hidden lg:flex items-center gap-6">
                        {/* Links */}
                        <div className="flex items-center gap-6 font-bold text-gray-500 dark:text-gray-300 text-sm">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <button
                                onClick={toggleTheme}
                                className="p-2.5 rounded-full hover:bg-orange-50 dark:hover:bg-gray-700 text-gray-500 dark:text-gray-300 hover:text-orange-600 transition"
